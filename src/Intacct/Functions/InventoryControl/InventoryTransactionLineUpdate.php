 ...
 */
class InventoryTransactionLineUpdate extends AbstractInventoryTransactionLine
{
    ...
    public function setLineNum(int $num): void
    {
        $this->line_num = $num;
    }
    ...
    public function writeXml(XMLWriter &$xml)
    {
        ...
        if (!$this->getLineNum()) {
            //fail
            throw new \Exception('Cannot update line without line number');
        }

        $xml->writeElement('line_num', $this->getLineNum());
